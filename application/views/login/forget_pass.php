...
<div class="container">
    ...
    <form class="form-signin" method="post" action="">
        ...
        <input style="margin: 10px 0px;"  name="email" type="text" id="inputEmail" class="form-control" placeholder="Email" required>
        <input style="margin: 10px 0px;" type="hidden" name="company" type="text" id="inputCom" class="form-control" value=NULL >
		
		
            <input style="margin: 5px 8px;" type="hidden" type="radio" name="login_type" value="User acccount problem" required>
