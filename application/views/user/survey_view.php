        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li>
                        <i class="fa fa-arrow-circle-right"></i>  <a href="<?php echo base_url().'user/all_survey_list';?>">All Survey</a>
                    </li>
                    <li class="active">
                        <i class="fa fa-arrow-circle-right"></i> Giving Survey
                    </li>
                </ol>
            </div>
        </div>
                ...
                <form id="survey_answer">
                    ...
                    foreach($survey as $surv)
                    {
                        ...
                        if($surv['question_type']== "Text Box"){ ?>
                            ...
                            <input name="<?php  echo $surv['question_id']; ?>" class="form-control" type="text">
                        <?php }elseif($surv['question_type']== "Radio"){ ?>
                            <?php if($surv['question_options'] != '') {
                                ...
                                foreach ($RadioOptions as $rOptions) {
                                    ?>
                                    <label class="form-check-inline mt5px"><input type="radio" name="<?php  echo $surv['question_id']; ?>" value="<?php echo $rOptions; ?>" rel="" class="question_type form-check-input" id="type_" required> <?php echo $rOptions; ?></label>
                                <?php }
                            }?>
                        <?php  }elseif($surv['question_type']== "Text Area"){ ?>
                            <textarea name="<?php  echo $surv['question_id']; ?>" class="form-control"></textarea>
                        <?php  }elseif($surv['question_type']== "Check Box"){ ?>
                            <?php if($surv['question_options'] != '') {
                                ...
                                foreach ($RadioOptions as $rOptions) {
                                    ?>
                                    <label class="form-check-inline mt5px"><input name="<?php  echo $surv['question_id']; ?>" type="checkbox" name="questionType_" value="<?php echo $rOptions; ?>" rel="" class="question_type form-check-input" id="type_" > <?php echo $rOptions; ?></label>
                                <?php }
                            }?>
                        <?php  }
                        echo '</div>';
                    ...
                    ?>
					<div style="background:#E8E8E9; margin:20px;padding: 10px">
						<div class="row">
							<div class="col-lg-10">
								<h4>Rating the prdact</h4>
							</div>
						</div>
						<div class="row" style="padding: .5px  40px">
							<span class="rating" style="float: left"><div class="userToRate" rel="<?php echo $surv['id']; ?>"></div></span>
						</div>
                    </div>
                    <div class="row">
