        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li>
                        <i class="fa fa-arrow-circle-right"></i>  <a href="<?php echo base_url().'vendor/survey_list';?>">Survey List</a>
                    </li>
                    <li class="active">
                ...
                <form id="survey_answer">
                    ...
                    <div class="row">
                        <div class="col-md-4" style="margin: 0 auto; ">
                            <button style="margin: 10px;widows: 0 auto" id="" class="btn btn-default">Update Survey</button>
                        </div>
                    </div>
                </form>
