        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li>
                        <i class="fa fa-arrow-circle-right"></i>  <a href="<?php echo base_url().'admin/all_survey_list';?>">All Survey</a>
                    </li>
                    <li class="active">
        ...
        <div class="row">
            ...
            <div class="col-lg-8" style="background:#c9c9cf; margin: 10px 40px">
                ...
                <form id="survey_answer">
                    ...
                    <div style="background:#E8E8E9; margin:20px;padding: 1px 150px 10px 10px">
					<h2>Title</h2>
                   ...
                   <!-- <div class="row">
                        <div class="col-md-4" style="margin: 0 auto; ">
                            <button style="margin: 10px;widows: 0 auto" id="submit_answer_btn" class="btn btn-default">Update Survey</button>
                        </div>
                    </div> -->
                </form>
