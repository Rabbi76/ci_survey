							...
							<table class="table table-bordered table-hover">
								...
								?>
                                        <tr>
                                            ...
                                            <td><?php echo '<a href="'.base_url().'admin/survey_details/'.$survey[0]['id'].'_'.$us['id'].'" style="margin:0px 5px; background-color: #D0C8C8;" class="btn btn-default">Survey Answer </a>'; ?></td>
                                        </tr>
                                    <?php } 
									//echo $count_user;
