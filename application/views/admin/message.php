            ...
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li >
                        ...
                        <i class="fa fa-arrow-circle-right"></i> <a href="<?php echo base_url().'admin/message';?>">All messaage</a>
                    </li>
 					<li class="active">
       ...
       <div class="row" style="margin:10px;">
			 <div class="col-lg-8">
				...
				foreach($message as $messag)
                {
						...
						echo '<h4><B>Name:</B> '.$messag['user_name'].'</h4>';
						echo '<h5><B>User type:</B> '.$messag['user_type'].'</h5>';
						echo '<h5><B>Subject:</B> '.$messag['subject'].'</h5>';
						echo'</div>';
						echo'</div>';
						echo '<div style="background:#95BDC9; margin:15px; padding: 3px; margin-right:80px;">';
						echo '<h5><b></b> '.$messag['message'].'</h5>';
						echo'</div>';
                   ...
                   <!-- <div class="col-lg-4" style=" float: right; margin-top:15px;">
                        <div class="panel panel-default">
							...
							<form method="post">
								...
								<br>To:
								<input style="margin: 5px 8px;" type="radio" name="login_type" value="user" required>User
								
									<input style="margin: 5px 8px; padding: 0px 20px"  type="radio" name="login_type" value="vendor" required>vendor
								...
								<textarea style="margin-top: 10px;" cols="40" rows="12" name="messaage" class="form-control" placeholder="Dscription( problem & details information)" required></textarea>
