        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li class="active">
                        <i class="fa fa-arrow-circle-right"></i> <a href="<?php echo base_url().'admin/vendors';?>">Vendor</a>
                    </li>
					<li class="active">
                            ...
                            <div class="panel-body">
								<div style="margin: 0 auto" class="list-group">
								   <?php
										...
										echo '<a href="'.base_url().'admin/view_survey/'.$surv['id'].'" style="margin:0px 5px; background-color: #D0C8C8; float:right" class="btn btn-default">Details </a>';
